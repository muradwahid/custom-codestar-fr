...
Description of the Custom CodeStar Fr
...
= How to use =
- First, install the Custom CodeStar Fr plugin
- Add the Custom CodeStar Fr from the block category called "Widgets" in Gutenberg editor.
...
2. Search For **Custom CodeStar Fr**
3. Click on the **Custom CodeStar Fr** to add the block

= Download & Upload: =
1. Download the **Custom CodeStar Fr** plugin (*.zip file*)
2. In your admin area, go to the Plugins menu and click on **Add New**
3. Click on **Upload Plugin** and choose the **`plugin-slug.zip`** file and click on **Install Now**
4. Activate the plugin and Enjoy!

= Manually: =
1. Download and upload the **Custom CodeStar Fr** plugin to the **`/wp-content/plugins/`** directory
2. Activate the plugin through the Plugins menu in WordPress


== Frequently Asked Questions ==

= Is Custom CodeStar Fr free? =

Yes, Custom CodeStar Fr is a free Gutenberg block plugin.
